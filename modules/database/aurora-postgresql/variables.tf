...
variable "vpc_discovery_tag" {
  description = "Tag key used for VPC discovery. Default: 'ou' (product repos). Set to 'Name' for integration-platform repos where VPC is identified by its Name tag."
  type        = string
  default     = "ou"
